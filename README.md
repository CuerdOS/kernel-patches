...
If you discovered a good patch to include here send it as an issue but test it before to avoid broken compilations (Almost If You hate Error 2 after waiting some time)
